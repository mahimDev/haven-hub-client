        ...
        <div className="mt-36">
            ...
            <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 mt-20 ">
                ...
                <motion.div
                    ...
                    className="relative   w-[400px]   rounded-md p-2 group overflow-hidden ">
                    <img className="rounded-md h-full group-hover:scale-110 duration-500" src="https://i.ibb.co.com/8m7tgZY/australia.jpg" alt="" />
                ...
                <motion.div
                    ...
                    className="relative  w-[400px]  overflow-hidden  rounded-md p-2 group ">
                    <img className="rounded-md h-full group-hover:scale-110 duration-500" src="https://i.ibb.co.com/znPKq81/us.jpg" alt="" />
                ...
                <motion.div
                    ...
                    animate={{ x: [0, 10, 0], backgroundColor: ['#F5F5F5', '#c7c5c5', '#F5F5F5'] }}
                    className="relative w-[400px]  overflow-hidden  rounded-md p-2 group ">
                    <img className="rounded-md h-full  group-hover:scale-110 duration-500" src="https://i.ibb.co.com/xmGf75g/uk.jpg" alt="" />
                ...
                <motion.div
                    ...
                    animate={{ y: [10, 0, 10], backgroundColor: ['#F5F5F5', '#c7c5c5', '#F5F5F5'] }}
                    className="relative w-[400px]  overflow-hidden   rounded-md p-2 group ">
                    <img className="rounded-md h-full group-hover:scale-110 duration-500" src="https://i.ibb.co.com/Sdhsmwv/canada.jpg" alt="" />
                ...
                <motion.div
                    ...
                    animate={{ y: [10, 0, 10], backgroundColor: ['#F5F5F5', '#c7c5c5', '#F5F5F5'] }}
                    className="relative w-[400px] overflow-hidden  rounded-md p-2 group ">
                    <img className="rounded-md h-full group-hover:scale-110 duration-500" src="https://i.ibb.co.com/fDdz96M/japan.jpg" alt="" />
                ...
                <motion.div
                    ...
                    animate={{ x: [0, 10, 0], backgroundColor: ['#F5F5F5', '#c7c5c5', '#F5F5F5'] }}
                    className="relative w-[400px] overflow-hidden  rounded-md p-2 group ">
                    <img className="rounded-md h-full  group-hover:scale-110 duration-500" src="https://i.ibb.co.com/M5wFtYT/United-Arab-Emirates.jpg" alt="" />
                ...
                <motion.div
                    ...
                    className="relative w-[400px]  overflow-hidden rounded-md p-2 group ">
                    <img className="rounded-md h-full group-hover:scale-110 duration-500" src="https://i.ibb.co.com/Df0LSKk/Country-China-1568x1116.jpg" alt="" />
                ...
                <motion.div
                    ...
                    className="relative w-[400px] overflow-hidden rounded-md p-2 group ">
                    <img className="rounded-md h-full group-hover:scale-110 duration-500" src="https://i.ibb.co.com/Lvz59bK/31cc1acbb7dcf38cd983e3425c1a752e.jpg" alt="" />
