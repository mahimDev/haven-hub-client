                        ...
                        <div className='lg:flex'>
                            <div className='  flex-1  lg:pt-64 pt-10'>
                                <div>
                                    ...
                                    <div>
                                        <div className='w-full h-full bg-darkGray text-lightGray absolute z-10 top-[80%]   rounded-tr-full'>
                            ...
                            <div className='flex-1'>
                                ...
                                >
                                    <img className='w-full max-h-[80vh] object-cover mt-5' src="https://i.ibb.co.com/M1QT7LY/prsentSm.png" alt="" />
                                </motion.div>
                            </div>
                        </div>
                    </div>
