        ...
        <div className="flex justify-center">
            ...
            <div className=" mt-28 shadow-2xl  w-fit p-10 rounded-md">
                ...
                >
                    ...
                    <div className="flex items-center border-b-2 border-darkGray gap-2 my-10" >
                        <img className="w-8 h-7 " src="https://img.icons8.com/?size=100&id=ywULFSPkh4kI&format=png&color=2E2E2E" alt="" />
                        <input
                    ...
                    <div className="flex items-center border-b-2 border-darkGray gap-2 my-10" >
                        <img className="w-8 h-7 " src="https://img.icons8.com/?size=100&id=2724&format=png&color=2E2E2E" alt="" />
                        <input
                    ...
                    <div className="flex mt-10">
                        <button className="rounded-sm w-full text-center py-3 text-xl font-semibold text-lightGray bg-[#2E2E2E] hover:shadow-xl duration-300">Sign Up</button>
                    </div>
                </form>
                <div className="flex pt-4 mt-4 border-t-2">
                    <button
                        onClick={handleGoogleLogin}
                        className="flex justify-center items-center  rounded-sm w-full  py-3 text-xl text-lightGray font-semibold bg-[#2E2E2E] hover:shadow-xl duration-300">
                ...
                <p className={`pt-2 text-center ${isDark ? 'text-lightText' : ''}`}>You have a account?
                    <Link to={'/login'}> <span className={`text-[#2E2E2E] border-b-2 hover:border-darkGray border-white ${isDark ? 'border-darkBg' : ''}`}
                    >SignIn </span>
                    </Link></p>
            </div>
        </div>
